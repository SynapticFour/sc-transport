...
Provides three implementations of the `Transport` trait for telemetry delivery:

| Crate | Transport | Status | When to use |
|-------|-----------|--------|-------------|
| sc-transport-core | HTTP SSE (Server-Sent Events) | **Stable** | Always available. Use this in production. |
